...
import com.abir.cameraabir.databinding.ActivityRoundCameraBinding;
...
public class RoundCamera extends AppCompatActivity {
    ActivityRoundCameraBinding binding;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRoundCameraBinding.inflate(getLayoutInflater());
